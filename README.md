...
4.	Under **SHARED ACCESS POLICIES**, create a new policy with **MANAGE** permissions.
  	...
  	![Shared Access Policies where you can create a policy with Manage permissions.](https://github.com/zvisha/azure-content/blob/master/articles/stream-analytics/media/stream-analytics-twitter-sentiment-analysis-trends/stream-ananlytics-shared-access-policies.png)
